...
import 'package:multiple_services/widgets/CountryStats.dart';
import 'package:multiple_services/constants.dart';
import 'package:multiple_services/providers/ListCountriesState.dart';
import 'package:multiple_services/widgets/StatefulWrapper.dart';
...
class CovidStats extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return StatefulWrapper(
        onInit: () {
           Provider.of<ListCountriesState>(context, listen: false).searchStats();
        },
        child: Scaffold(
                  ...
                  child: Stack(children: <Widget>[
                    ...
                    Positioned(
                        ...
                        child: Container(
                            ...
                            // ignore: avoid_print
                            onTap: () {
                              Provider.of<ListCountriesState>(context,
                                      listen: false)
                                  .searchStatsByCountry(textController.text);
                            }))
                  ])),

              Expanded(child: Consumer<ListCountriesState>(
                  builder: (context, listCountriesState, child) {
                return ListView.builder(
                  itemCount: listCountriesState.countries.length,
                    ...
                    return Card(
                        ...
                        child: ListTile(
                          leading: CircleAvatar(
                            child:
                                Text(listCountriesState.countries[index].flag),
                          ...
                          title: RichText(
                            text: TextSpan(children: <TextSpan>[
                              TextSpan(
                                  text:
                                      listCountriesState.countries[index].name +
                                          "\n",
                              ...
                              TextSpan(
                                text: "\t\tDeaths : " +
                                    listCountriesState.countries[index].deaths +
                                    "\n",
                                style: const TextStyle(
